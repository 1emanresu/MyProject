package com.pay.wapalipay.server.util;
...
import com.pay.wapalipay.server.config.AlipayConfig;
import com.pay.wapalipay.server.sign.MD5;
import com.pay.wapalipay.server.sign.RSA;
import com.pay.wapalipay.server.util.httpClient.HttpProtocolHandler;
import com.pay.wapalipay.server.util.httpClient.HttpRequest;
import com.pay.wapalipay.server.util.httpClient.HttpResponse;
import com.pay.wapalipay.server.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
     ...
     * @return 提交表单HTML文本
     */
    public static String buildRequest(String ALIPAY_GATEWAY_NEW, Map<String, String> sParaTemp, String strMethod, String strButtonName, String title, String basePath, String titletime) {
    	 //待请求参数数组
        ...
        sbHtml.append("<div style=\"margin-top: 250px\" align=\"center\" >");
        sbHtml.append("<p class=\"pzs\">"+title+"</p>");
        sbHtml.append("<img src='"+basePath+"/img/ajax-loaders/ajax-loader-7.gif' />");
        sbHtml.append("</div>");
        ...
        sbHtml.append("function sub(){");
        sbHtml.append("document.alipaysubmit.submit();");
        sbHtml.append("}");
        sbHtml.append("setTimeout(sub,"+titletime+");");
