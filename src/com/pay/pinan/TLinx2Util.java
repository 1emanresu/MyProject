...
public class TLinx2Util {
     ...
     * @return
     */
    public static String sign(JSONObject respObject) {
        String sortStr = null;
        String sign    = null;
        ...
        try {
             ...
             * 1 A~z排序(加上open_key)
             */
            sortStr = TLinxUtil.sort(respObject);
     ...
     * @return
     */
    public static String sign(Map respObject) {
        String sortStr = null;
        String sign    = null;
    ...
    public static void handleEncrypt(TreeMap<String, String> datamap, TreeMap<String, String> postmap) throws Exception {
    	...
    	JSONObject dataobj = (JSONObject) JSON.toJSON(datamap);
