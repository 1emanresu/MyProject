...
public class PaymentForOnlineService {
	...
	private static String p1_MerId 			= Gateway.dao.findById(1).getStr("gateway_merid"); 			// 商家ID
	private static String queryRefundReqURL = "https://www.yeepay.com/app-merchant-proxy/node";	// 请求地址
	private static String keyValue 			= Gateway.dao.findById(1).getStr("gateway_key");				// 商家密钥
...
/*	public static void main(String[] args) {
		boolean boo = verifyCallback("39ae679c426d33352694c340283e8371","10012216266","Buy","1","714226256519841I","0.2","RMB","admin(海阳浩松网络科技有限公司余额","OR201402370902825013894622","","charge-user_charge-1-0-1-0","2","3jXt43jsT756qmN080Y06RsiU5z2Ez66R3s3Woi6NZWV08549AX88rne7841");
