...
public class RSAUtil {
	...
	public static byte[] encryptByPublicKeyByPKCS1Padding(byte[] data, String publicKey)
		...
		System.out.println("111111111111111111111111111111111111111"+data);
		System.out.println("222222222222222222222222222222222222222"+publicKey);
	...
	public static void main(String[] args) {
		String reqJsonStr = "{'amount':'1000.00','appid':'0000001057'}";
		...
		try {
			str = RSAUtil.encryptByPublicKeyByPKCS1Padding(reqJsonStr.getBytes("UTF-8"), PUBLIC_KEY);
			//String reqParams = Base64.encodeBase64String(str);
			
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		String reqParams =org.apache.commons.codec.binary.Base64.encodeBase64String(str);
