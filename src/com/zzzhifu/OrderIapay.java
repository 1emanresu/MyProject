...
import com.zzzhifu.sign.BareBonesBrowserLaunch;
import com.zzzhifu.sign.SignHelper;
public class OrderIapay {
	/**
	...
	public static String ReqData(String appid, int waresid,String waresname,String cporderid ,float price,String appuserid,String cpprivateinfo,String notifyurl) {
		...
		System.out.println("请求appid:"+appid);
		System.out.println("请求数据:"+data);
		return data;
	}
	
public static String ReqData2(String tid, String url_r,String url_h,String ptype) {
		...
		jsonObject.put("url_r", url_r);
		jsonObject.put("url_h", url_h);
		...
		//https://web.iapppay.com/dpay/gateway?data=UTF8_URLEncode(data)&sign=UTF8_URLEncode(sign)&sign_type=RSA
		String data="";
		try {
			data = "data=" + java.net.URLEncoder.encode(content, "UTF-8") + "&sign=" + java.net.URLEncoder.encode(sign, "UTF-8")+ "&sign_type=RSA";
...
//CheckSign(             String appid,          int waresid,                  String waresname,   String cporderid, float prce,     String appuserid,        String cpprivateinfo,       String notifyurl)
		CheckSign( IAppPaySDKConfig.APP_ID,IAppPaySDKConfig.WARES_ID_1,"aaa", "123123",0.1f, "108412312312310", "1231231231", "http://58.250.160.241:8888/IapppayCpSyncForPHPDemo/TradingResultsNotice.php");
		H5orPCpay(transid);
	}
