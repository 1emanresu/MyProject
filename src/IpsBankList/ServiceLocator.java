...
public class ServiceLocator extends org.apache.axis.client.Service implements IpsBankList.Service {
    ...
    private java.lang.String ServiceSoap_address = "http://webservice.ips.net.cn/web/Service.asmx";
    ...
    public IpsBankList.ServiceSoap getServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public IpsBankList.ServiceSoap getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            IpsBankList.ServiceSoapStub _stub = new IpsBankList.ServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (IpsBankList.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                IpsBankList.ServiceSoapStub _stub = new IpsBankList.ServiceSoapStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://IpsBankList", "Service");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://IpsBankList", "ServiceSoap"));
        }
