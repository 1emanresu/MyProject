...
<!-- Mirrored from www.kuaiyinpay.com/index_new/applicableService/creditCardPayment.jsp by HTTrack Website Copier/3.x [XR&CO'2013], Sun, 30 Mar 2014 10:29:45 GMT -->
...
<!-- 	<div class="ban">
  ...
  <div class="mmain">
   <div class="wrap">
       ...
       <ul class="lnavlist">
         ...
         <li onclick="setTab('lnav',4,4)" ><a href="javascript:void(0);" id="lnav4" class="hover">便民应用</a>
          <div class="lbox" id="con_lnav_4" style="display:block;">
             <ul>
               <li class="hover"><a href="creditCardPayment.jsp">信用卡还款</a></li>
    ...
    <!--mleft end-->
    <div class="mright">
      <div class="curr"><a href="#">首页</a> > <a href="../account/person.jsp">快银产品 </a> > 便民应用 > <span class="red">信用卡还款</span></div>
      <div class="mcon">
        <div class="mr_tit"><h2>企业账户</h2></div>
		<div class="procon">
           	<div class="proabout">
                <div class="prott"><img src="<%=basePath%>/static/newImages/prott.jpg" width="121" height="33" /></div>
                 <p class="prop1">快银支付信用卡还款业务支持多家银行在线还款。</p>
            </div>
