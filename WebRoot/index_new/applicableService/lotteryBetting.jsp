...
<!-- Mirrored from www.kuaiyinpay.com/index_new/applicableService/lotteryBetting.jsp by HTTrack Website Copier/3.x [XR&CO'2013], Sun, 30 Mar 2014 10:29:45 GMT -->
...
<!-- 	<div class="ban">
  ...
  <div class="mmain">
   <div class="wrap">
         ...
         <li onclick="setTab('lnav',4,4)" ><a href="javascript:void(0);" id="lnav4" class="hover">便民应用</a>
          <div class="lbox" id="con_lnav_4" style="display:block;">
             <ul>
               ...
               <li class="hover"><a href="lotteryBetting.jsp">彩票投注</a></li>
    ...
    <!--mleft end-->
    <div class="mright">
      <div class="curr"><a href="#">首页</a> > <a href="../account/person.jsp">快银产品 </a> > 便民应用 > <span class="red">彩票投注</span></div>
      <div class="mcon">
        <div class="mr_tit"><h2>彩票投注</h2></div>
		<div class="procon">
           	<div class="proabout">
                <div class="prott"><img src="<%=basePath%>/static/newImages/prott.jpg" width="121" height="33" /></div>
                <p class="prop1">快银支付彩票投注是快银为广大用户提供购买彩票的便捷服务，用户可通过快</p>
      			<p class="prop2">银支付网站及移动客户端更方便快捷地购买彩票。</p>
            </div>
