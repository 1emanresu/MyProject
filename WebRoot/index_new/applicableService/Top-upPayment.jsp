...
<!-- Mirrored from www.kuaiyinpay.com/index_new/applicableService/Top-upPayment.jsp by HTTrack Website Copier/3.x [XR&CO'2013], Sun, 30 Mar 2014 10:29:46 GMT -->
...
<!-- 	<div class="ban">
  ...
  <div class="mmain">
   <div class="wrap">
         ...
         <li onclick="setTab('lnav',4,4)" ><a href="javascript:void(0);" id="lnav4" class="hover">便民应用</a>
          <div class="lbox" id="con_lnav_4" style="display:block">
             <ul>
               ...
               <li ><a href="lotteryBetting.jsp">彩票投注</a></li>
               <li ><a href="superTransfer.jsp">超级转账</a></li>
               <li ><a href="ticketsCenter.jsp">票务中心</a></li>
               <li class="hover"><a href="Top-upPayment.jsp">充值缴费</a></li>
             </ul>
           </div>
         </li>
       </ul>
    ...
    <!--mleft end-->
    <div class="mright">
      <div class="curr"><a href="#">首页</a> > <a href="../account/person.jsp">快银产品 </a> > 便民应用 > <span class="red">充值缴费</span></div>
      <div class="mcon">
        <div class="mr_tit"><h2>充值缴费</h2></div>
		<div class="procon">
           	<div class="proabout">
                <div class="prott"><img src="<%=basePath%>/static/newImages/prott.jpg" width="121" height="33" /></div>
                <p class="prop1">充值缴费是快银支付为居民公共事业缴费提供便捷通道，可通过快银支付完成</p>
      			<p class="prop2">水费、电费、燃气费等的充值缴费。</p>
            </div>
            <div class="protitle"><img src="<%=basePath%>/static/newImages/prott2.jpg" width="608" height="34" /></div>
            <div class="prodebox">
              <p align="center"><img src="<%=basePath%>/static/newImages/prode2.jpg" /></p>
            </div>
        </div>
      </div>
    </div>
