...
<!-- Mirrored from www.kuaiyinpay.com/index_new/applicableService/ticketsCenter.jsp by HTTrack Website Copier/3.x [XR&CO'2013], Sun, 30 Mar 2014 10:29:46 GMT -->
...
<!-- 	<div class="ban">
  ...
  <div class="mmain">
   <div class="wrap">
         ...
         <li onclick="setTab('lnav',4,4)" ><a href="javascript:void(0);" id="lnav4" class="hover">便民应用</a>
          <div class="lbox" id="con_lnav_4" style="display:block;">
             <ul>
               ...
               <li class="hover"><a href="ticketsCenter.jsp">票务中心</a></li>
    ...
    <!--mleft end-->
    <div class="mright">
      <div class="curr"><a href="#">首页</a> > <a href="../account/person.jsp">快银产品 </a> > 便民应用 > <span class="red">票务中心</span></div>
      <div class="mcon">
        <div class="mr_tit"><h2>票务中心</h2></div>
		<div class="procon">
           	<div class="proabout">
                <div class="prott"><img src="<%=basePath%>/static/newImages/prott.jpg" width="121" height="33" /></div>
                <p class="prop1">票务中心是快银支付提供订购票务的便捷通道，可通过快银支付完成航空公司</p>
      			<p class="prop2">机票、长途客车票等票务预订。</p>
            </div>
