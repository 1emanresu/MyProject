...
<!-- 	<div class="ban">
  ...
  <div class="mmain">
   <div class="wrap">
       ...
       <ul class="lnavlist">
         ...
         <li class="hover" onclick="setTab('lnav',2,4)" ><a href="javascript:void(0);" id="lnav2" class="hover">支付工具</a>
          <div class="lbox" id="con_lnav_2" style="display:block;">
             <ul>
                <li class="hover"><a href="rmbGateway.jsp">人民币网关支付</a></li>
    ...
    <!--mleft end-->
    <div class="mright">
      <div class="curr"><a href="#">首页</a> > <a href="../account/person.jsp">快银产品 </a> > 支付工具 > <span class="red">人民币网关支付</span></div>
      <div class="mcon">
        <div class="mr_tit"><h2>人民币网关支付</h2></div>
		<div class="procon">
           	<div class="proabout">
                <div class="prott"><img src="<%=basePath%>/static/newImages/prott.jpg" width="121" height="33" /></div>
                 <p class="prop1">快银支付为买卖双方提供的解决买卖双方交易所涉及的资金往来的支付服务。</p>
                 <p class="prop2">商家接入快银支付人民币支付后，消费者即可通过多种支付方式向商家付款。</p>
                 <p class="prop3">快银人民币支付支持国内绝大多数银行卡的在线支付、快银支付账户支付。</p>
            </div>
            <div class="protitle"><img src="<%=basePath%>/static/newImages/prott2.jpg" width="608" height="34" /></div>
            <div class="prodebox">
              <p align="center"><img src="<%=basePath%>/static/newImages/prode9.jpg" /></p>
            </div>
        </div>
      </div>
    </div>
...
<!-- Mirrored from www.kuaiyinpay.com/index_new/payTools/rmbGateway.jsp by HTTrack Website Copier/3.x [XR&CO'2013], Sun, 30 Mar 2014 10:29:42 GMT -->
</html>