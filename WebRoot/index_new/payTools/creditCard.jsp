...
<!-- 	<div class="ban">
  ...
  <div class="mmain">
   <div class="wrap">
          ...
          <div class="lbox" id="con_lnav_2" style="display:block;">
             <ul>
              <li ><a href="rmbGateway.jsp">人民币网关支付</a></li>
               ...
               <li class="hover"><a href="creditCard.jsp">外币信用卡支付</a></li>
             </ul>
           </div>
         </li>
    ...
    <!--mleft end-->
    <div class="mright">
      <div class="curr"><a href="#">首页</a> > <a href="../account/person.jsp">快银产品 </a> > 支付工具 > <span class="red">外币信用卡支付</span></div>
      <div class="mcon">
        <div class="mr_tit"><h2>外币信用卡支付</h2></div>
		<div class="procon">
           	<div class="proabout">
                <div class="prott"><img src="<%=basePath%>/static/newImages/prott.jpg" width="121" height="33" /></div>
                 <p class="prop1">支持VISA,MasterCard,AMERICAN EXPRESS,JCB四种外币卡。</p>
            </div>
            <div class="protitle"><img src="<%=basePath%>/static/newImages/prott2.jpg" width="608" height="34" /></div>
            <div class="prodebox">
              <p align="center"><img src="<%=basePath%>/static/newImages/prode6.jpg" /></p>
            </div>
        </div>
      </div>
    </div>
...
<!-- Mirrored from www.kuaiyinpay.com/index_new/payTools/creditCard.jsp by HTTrack Website Copier/3.x [XR&CO'2013], Sun, 30 Mar 2014 10:29:43 GMT -->
</html>