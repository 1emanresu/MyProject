...
<!-- 	<div class="ban">
  ...
  <div class="mmain">
   <div class="wrap">
         ...
         <li class="hover" onclick="setTab('lnav',2,4)" ><a href="javascript:void(0);" id="lnav2" class="hover">支付工具</a>
          <div class="lbox" id="con_lnav_2" style="display:block;">
             <ul>
               ...
               <li class="hover"><a href="mobileNoCard.jsp">移动无卡支付</a></li>
    ...
    <!--mleft end-->
    <div class="mright">
      <div class="curr"><a href="#">首页</a> > <a href="#">快银产品 </a> > 支付工具 > <span class="red">移动无卡支付</span></div>
      <div class="mcon">
        <div class="mr_tit"><h2>移动无卡支付</h2></div>
		<div class="procon">
           	<div class="proabout">
                <div class="prott"><img src="<%=basePath%>/static/newImages/prott.jpg" width="121" height="33" /></div>
                 <p class="prop1">基于移动客户端或wap网络，并在移动端内嵌支付插件进行付款结算的支付</p>
                 <p class="prop2">方式。</p>
            </div>
            <div class="protitle"><img src="<%=basePath%>/static/newImages/prott2.jpg" width="608" height="34" /></div>
            <div class="prodebox">
              <p align="center"><img src="<%=basePath%>/static/newImages/prode7.jpg" /></p>
            </div>
        </div>
      </div>
    </div>
...
<!-- Mirrored from www.kuaiyinpay.com/index_new/payTools/mobileNoCard.jsp by HTTrack Website Copier/3.x [XR&CO'2013], Sun, 30 Mar 2014 10:29:43 GMT -->
</html>