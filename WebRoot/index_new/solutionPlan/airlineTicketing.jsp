...
<!-- 	<div class="ban">
  ...
  <div class="mmain">
   <div class="wrap">
      ...
      <div class="lnav">
       <ul class="lnavlist">
         <li ><a href="bigGoodsTrad.jsp">大宗商品交易</a></li>
               ...
               <li><a href="airlineTicketing.jsp" class="hover">航空票务</a></li>
    ...
    <div class="mright">
      <div class="curr"><a href="#">首页</a> > 解决方案 > <span class="red">航空票务</span></div>
      <div class="mcon">
        <div class="mr_tit"><h2>航空票务</h2></div>
        <div class="solcon">
         	<p>快银支付了解到机票行业所存在的支付结算问题主要有：</p>
			<p class="pline">资金量要求高</p>
			<p class="pline">多方分润结算繁琐</p>
			<p class="pline">分销渠道支付混乱，导致开发难度上升</p>
			<p class="pline">退款麻烦，服务成本加大</p>
			<p class="solimg"><img src="../../static/newImages/solimg.jpg" width="174" height="31" /></p>
			<p class="pline">快银支付为其提供统一收付、统一结算的解决方案，多种支付渠道，可通过电脑、手机等客户终端进行支付。</p>
			<p class="pline">付款额度无限制，方便大额支付。</p>
			<p class="pline">提供信用支付模式，允许“先出票，后付款”，无须任何担保和抵押，为航空公司用户的差旅活动提供方便。</p>
			<p class="pline">提供托管模式，用户可事先通过线上线下多种支付方式将资金充入商户账户，这部分资金将成为预付款，为其后续在商户处进行购票、付款等交易时使用。</p>
			<p class="pline">提供资金管理平台，为代理商销售渠道进行统一财务管理，提升资金管理效率，支持与多家银行进行对账结算。</p>
			<p class="pline">多项保障机制，严格风险控制，维护资金安全。</p>
        </div>
        <div class="solbox">
...
<!-- Mirrored from www.kuaiyinpay.com/index_new/solutionPlan/airlineTicketing.jsp by HTTrack Website Copier/3.x [XR&CO'2013], Sun, 30 Mar 2014 10:29:48 GMT -->
</html>