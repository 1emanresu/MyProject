...
<!-- 	<div class="ban">
  ...
  <div class="mmain">
   <div class="wrap">
      ...
      <div class="lnav">
       <ul class="lnavlist">
         <li ><a href="bigGoodsTrad.jsp">大宗商品交易</a></li>
                ...
                <li><a href="educationSector.jsp" class="hover">教育行业</a></li>
    ...
    <div class="mright">
      <div class="curr"><a href="#">首页</a> > 解决方案 > <span class="red">教育行业</span></div>
      <div class="mcon">
        <div class="mr_tit"><h2>教育行业</h2></div>
        <div class="solcon">
         	<p>快银支付针对教育行业收付款集中、收付具有周期性的特点，了解到其支付结算所存在的问题主要有：</p>
			<p class="pline">现场报名收费困难，成本高且易造成学员流失</p>
			<p class="pline">网络教学支付系统开发维护成本高，投入增加</p>
			<p class="solimg"><img src="../../static/newImages/solimg.jpg" width="174" height="31" /></p>
			<p class="pline">快银支付为其提供统一收付、统一结算的解决方案。可以免去现场报名收费模式带来的人力成本和其他额外成本，帮助网络教学、民办学校、职业培训、教辅、早教、数字化校园等教育机构通过互联网支付、移动支付完成报名以及缴费工作。</p>
			<p class="pline">在订单和资金分流、归集方面具有高效的管理运作功能。</p>
			<p class="pline">系统的信息管理后台，便于保管查询学员信息。</p>
			<p class="pline">支持电脑、手机等多种支付终端。</p>
        </div>
        <div class="solbox">
...
<!-- Mirrored from www.kuaiyinpay.com/index_new/solutionPlan/educationSector.jsp by HTTrack Website Copier/3.x [XR&CO'2013], Sun, 30 Mar 2014 10:29:48 GMT -->
</html>