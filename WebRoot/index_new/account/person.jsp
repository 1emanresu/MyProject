...
<!-- Mirrored from www.kuaiyinpay.com/index_new/account/person.jsp by HTTrack Website Copier/3.x [XR&CO'2013], Sun, 30 Mar 2014 10:29:38 GMT -->
  ...
  <div class="mmain">
   <div class="wrap">
    <div class="mleft">
      ...
      <div class="lnav">
       <ul class="lnavlist">
         <li class="hover" onclick="setTab('lnav',1,4)" ><a href="javascript:void(0);" id="lnav1">万鑫账户</a>
           <div class="lbox" id="con_lnav_1" style="display:block">
             <ul>
                <li class="hover"><a href="person.jsp">个人账户</a></li>
                <li ><a href="merchant.jsp">企业账户</a></li>
             </ul>
           </div>
         </li>
    ...
    <!--mleft end-->
      <div class="mright">
      <div class="curr"><a href="#">首页</a> > <a href="#">快银产品 </a> > 快银账户 > <span class="red">个人账户</span></div>
      <div class="mcon">
        <div class="mr_tit"><h2>个人账户</h2></div>
		<div class="procon">
           	<div class="proabout">
            <div class="prott"><img src="<%=basePath%>/static/newImages/prott.jpg" width="121" height="33" /></div>
              <p class="prop1">快银支付提供个人用户资金管理服务，用户可通过快银账户进行查询、收款、</p>
              <p class="prop2">付款、充值、提现等多种操作，轻松实现在线消费在线理财等。</p>
            </div>
             <div class="protitle"><img src="<%=basePath%>/static/newImages/prott2.jpg" width="608" height="34" /></div>
              <div class="prodebox">
                 <p align="center"><img src="<%=basePath%>/static/newImages/prode10.jpg" /></p>
              </div>
        </div>
      </div>
    </div>
...
<!-- Mirrored from www.kuaiyinpay.com/index_new/account/person.jsp by HTTrack Website Copier/3.x [XR&CO'2013], Sun, 30 Mar 2014 10:29:40 GMT -->
</html>