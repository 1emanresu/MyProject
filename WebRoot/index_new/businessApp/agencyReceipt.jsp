...
<!-- 	<div class="ban">
  ...
  <div class="mmain">
   <div class="wrap">
         ...
         <li onclick="setTab('lnav',2,4)" ><a href="javascript:void(0);" id="lnav2">支付工具</a>
          ...
          <div class="lbox" id="con_lnav_3" style="display:block;">
             <ul>
                ...
                <li class="hover"><a href="agencyReceipt.jsp">代收代付</a></li>
    ...
    <!--mleft end-->
      <div class="mright">
      <div class="curr"><a href="#">首页</a> > <a href="../account/person.jsp">快银产品 </a> > 企业应用 > <span class="red">代收代付</span></div>
      <div class="mcon">
        <div class="mr_tit"><h2>代收代付</h2></div>
		<div class="procon">
           <div class="proabout">
            <div class="prott"><img src="<%=basePath%>/static/newImages/prott.jpg" width="121" height="33" /></div>
                <p class="prop1">委托代收和委托代付的合称，代收代付服务是快银支付为收、付款企业提供</p>
                <p class="prop2">的面向企业或个人收取各类款项的服务，通过事先委托授权，快银支付依据指</p>
                <p class="prop3">令到指定账户间资金支付结算。</p>
           </div>
           <div class="protitle"><img src="<%=basePath%>/static/newImages/prott2.jpg" width="608" height="34" /></div>
           <div class="prodebox">
               <p align="center"><img src="<%=basePath%>/static/newImages/prode5.jpg" /></p>
           </div>
        </div>
      </div>
    </div>
...
<!-- Mirrored from www.kuaiyinpay.com/index_new/businessApp/agencyReceipt.jsp by HTTrack Website Copier/3.x [XR&CO'2013], Sun, 30 Mar 2014 10:29:44 GMT -->
</html>