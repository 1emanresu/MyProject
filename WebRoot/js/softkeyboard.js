...
document.write ('<td colspan=\"2\"> <input class=input99 name=\"showCapsLockValue\" type=reset value=\" 小写状态 \" disabled ></td>');
document.write ('</tr>');
...
document.write ('<INPUT class=button99 type=button value=确定输入 name=\"Submit3\" onclick=\"OverInput(curEditName);\"> <INPUT class=button99 type=reset onclick=\"resetValue();\" value=重新输入 name=\"Submit23\"> ');
document.write ('<input class=button99 type=button value=\"关闭输入窗\" name=\"Submit222\" onclick=\"closekeyboard(curEditName);\"> </td>');
...
{
CapsLockValue=1
Calc.showCapsLockValue.value=" 大写状态 ";
}
else 
{
CapsLockValue=0
Calc.showCapsLockValue.value=" 小写状态 ";
}
}