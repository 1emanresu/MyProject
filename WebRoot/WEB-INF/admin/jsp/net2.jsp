...
<body>
	...
	<div class="pageContent">
		...
		<table class="table" width="1200" layoutH="138">
			...
			<tbody>
				<%-- <%@ include file="/WEB-INF/admin/jsp/net4.jsp" %> --%>
 ...
 %>
	  ...
	  <EMBED id="audio" src="C:\Users\Administrator\Desktop\BEEP1.WAV" width=300 height=45 type=audio/mpeg loop="-1" autostart="false" volume="0"></EMBED> 
</body>

<script type="text/javascript">
/* 	$(function() {
		var status = $("#code").date("status");
		if (status == 2) {
			alert(1)
		}
	}) */
