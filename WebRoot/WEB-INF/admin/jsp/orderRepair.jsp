...
<body>
	<form id="pagerForm" method="post" action="<%=adminbasePath%>/orderrepair">
	...
	<div class="pageHeader">
		<form rel="pagerForm" action="<%=adminbasePath%>/orderrepair" onsubmit="return navTabSearch(this);" method="post">
			<input type="hidden" name="pageNum" value="1" />
