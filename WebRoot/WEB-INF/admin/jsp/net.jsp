...
<body>
	<form id="pagerForm" method="post" action="<%=adminbasePath%>/net/MyQueryList/">
	...
	<div class="pageHeader">
		<form rel="pagerForm" action="<%=adminbasePath%>/net/MyQueryList/" onsubmit="return navTabSearch(this);" method="post">
