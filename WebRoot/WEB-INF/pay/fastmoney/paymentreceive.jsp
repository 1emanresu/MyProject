...
if(flag){
  		switch(Integer.parseInt(payResult))
  		{
  			case 10:
  					...
  					*/
  					rtnOK=1;
  					PaymentService.service.netcallback(dealId, orderId, bankDealId, dealTime, dealTime);
  					rtnUrl = basePath+"/payment/showPayOk";
  					response.sendRedirect(basePath+"/payment/showPayOk");
  					break;
  			default:
  					rtnOK=1;
  					PaymentService.service.failure(orderId, dealTime);
  					rtnUrl = basePath+"/payment/showPayNo";
