...
if(verify)
{
	if (succ!=null)
	{
	 ...
	 {
		 YeepayService.service.netcallback(ipsbillno, billno, bankbillno, mydate, mydate);
		 YeepayService.service.asynchronous(billno);
	 }
	 else
	 {
		 YeepayService.service.failure(billno, mydate);
